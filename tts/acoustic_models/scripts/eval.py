...
if __name__ == "__main__":
    ...
    tts_model_path = "C:\\SRS\\data\\cfm_tts\\epoch=14-step=62505.ckpt"
    voc_model_path = "C:\\SRS\\data\\cfm_tts\\vocos_checkpoint_epoch=3_step=100000_val_loss=8.2706.ckpt"
    ...
    tests = [
        {
            ...
            "utterances": """
«Норильский никель» — диверсифицированная го+рно металлургическая компания <break time='1s'/>.
Производственные подразделения группы компаний «Норильский никель» расположены в России
в Норильском промышленном районе, на Кольском полуострове и в Забайкальском крае, а также в Финляндии.
            """,
        },
    ]
