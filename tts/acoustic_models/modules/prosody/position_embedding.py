...
def make_positions(tensor, padding_idx, left_pad):
    ...
    Position numbers begin at padding_idx+1. Padding symbols are ignored, but it is
    necessary to specify whether padding is added on the left side (left_pad=True) or
    right side (left_pad=False).
...
class SinusoidalPositionalEmbedding(nn.Module):
    ...
    def __init__(self, embedding_dim, padding_idx=0, left_pad=0, max_pos=8192):
        super().__init__()
    ...
    def get_embedding(num_embeddings, embedding_dim, padding_idx=None):
        ...
        This matches the implementation in tensor2tensor, but differs slightly from
        the description in Section 3.5 of "Attention Is All You Need".
