...
__all__ = ["StyleTTS2", "StyleTTS2Params"]


class StyleTTS2Params(StyleEncoderParams):
    pass


class StyleTTS2(Component):
...
class ResBlk(nn.Module):
    def __init__(
        self, dim_in, dim_out, actv=nn.LeakyReLU(0.2), normalize=False, downsample="none"
    ):
        super().__init__()
        self.actv = actv
