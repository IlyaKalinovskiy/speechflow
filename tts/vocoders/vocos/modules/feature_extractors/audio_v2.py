...
__all__ = ["AudioFeaturesV2", "AudioFeaturesV2Params"]


class AudioFeaturesV2Params(BaseTorchModelParams):
...
class AudioFeaturesV2(FeatureExtractor):
    params: AudioFeaturesV2Params

    def __init__(self, params: AudioFeaturesV2Params):
