...
__all__ = ["NSFiSTFTHiFiGANHead", "NSFiSTFTHiFiGANHeadParams"]


class NSFiSTFTHiFiGANHeadParams(BaseTorchModelParams):
    input_dim: int = 512
    inner_dim: int = 1024
...
class NSFiSTFTHiFiGANHead(WaveformGenerator):
    params: NSFiSTFTHiFiGANHeadParams

    def __init__(self, params: NSFiSTFTHiFiGANHeadParams):
