...
LANGUAGES: dict = whisper.tokenizer.LANGUAGES  # type: ignore
...
if __name__ == "__main__":
    ...
    for file_ext in ["*.wav", "*.mp3", "*.flac"]:
        file_list: tp.List[Path] = list(args.data_root.rglob(file_ext))
        ...
        for path in tqdm(file_list, desc="Audio files transcription"):
            ...
            file_name: Path = path.with_suffix(".json")
