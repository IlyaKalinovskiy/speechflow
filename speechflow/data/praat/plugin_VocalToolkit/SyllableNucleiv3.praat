...
form Detect Syllables and Filled Pauses in Speech Utterances
  comment © Script Syllable Nuclei v3. 2019 Nivja de Jong, Ton Wempe, Jos J A Pacilly.
...
#   appendInfoLine: directory$ + selection$
  ...
  if data$ == "Praat Info window" and dataCollectionType$ == "OverWriteData"
    writeInfoLine: "---------------------------------------------------------------------------------------------------------"
    appendInfoLine: "© Nivja H. de Jong, Jos Pacilly & Willemijn Heeren (2021)"
    appendInfoLine: "PRAAT scripts to measure speed fluency and breakdown fluency in speech automatically,"
    appendInfoLine: "Assessment in Education: Principles, Policy & Practice, 28:4, 456-476, DOI: 10.1080/0969594X.2021.1951162"
    appendInfoLine: "https://doi.org/10.1080/0969594X.2021.1951162"
    appendInfoLine: "---------------------------------------------------------------------------------------------------------"
    appendInfoLine: ""

# print a single header line with column names and units
    appendInfo: "name, nsyll, npause, dur(s), phonationtime(s), speechrate(nsyll/dur), articulation_rate(nsyll/phonationtime), ASD(speakingtime/nsyll)"
